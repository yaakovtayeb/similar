...
WHERE site="criteo.com*"
and year=17 and  country<999 and month=5
order by month, day;

hive -e "set hive.cli.print.header=true; SELECT * FROM yaakovt.popularpages;">/home/yaakov.tayeb/output/criteo5.tsv;
...
AND site="criteo.com*"
and year=17 and  country<999 and (month=3 or month=4);

hive -e "set hive.cli.print.header=true; SELECT * FROM yaakovt.popularpages;">/home/yaakov.tayeb/output/criteo.tsv;